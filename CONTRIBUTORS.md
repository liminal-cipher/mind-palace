...
- **소감**:
  > "주제적으로도 기술적으로도 고민이 많은 프로젝트였는데, 팀원들과 좋은 결과물과 함께 마무리 지을 수 있어서 좋았습니다. 모두 감사했습니다."
...
- **소감**:
  > "전처리나 GraphRAG에서 시간이 오래 걸리는 것 같아 아쉬웠습니다. 이후 시간 단축 방안에 대해 고민해보면 좋을 것 같습니다. 좋은 프로젝트에 좋은 팀원분들과 함께해서 감사했습니다!"
...
- **소감**:
  > "마지막 프로젝트이기 때문에 잘하고 싶은 마음도 컸고 구현해보고 싶은 기능도 많았던 프로젝트였습니다. 팀원들의 도움이 있어 성장할 수 있었고 좋은 결과물을 완성할 수 있었습니다. 팀원들에게 정말 감사합니다!"
...
- **소감**:
  > "MS 마지막 프로젝트를 아름답게 마무리해서 좋습니다. 언젠가 기억의 궁전이 상용화될 날이 오길… 다들 건강하세요!"
...
- **소감**:
  > "기억의 궁전은 서비스의 편의성과 기술적 구현 등 많은 고민을 통해 완성된 것 같습니다. 그만큼 얻어간 것이 많은 프로젝트였습니다."
...
- **소감**:
  > "기억의 궁전이라는 암기법을 통한 IT적 접근 발상이 새로웠고, 저의 역량과 한계를 넘고 한층 더 성장하는 계기가 된 것 같아 유의미한 경험이었습니다."
