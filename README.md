...
| 사용자 편집 (HITL) | 방·개념을 드래그로 옮기고 단서를 직접 수정 | 신뢰성·책임성 |
...
| 공정성 | 전국 랜드마크 · Azure Safety Filter · RAG 품질 점검(관련성·근거 충실성) |
...
| 담당 | 산출물 |
| --- | --- |
| GraphRAG 파이프라인·백엔드 | 인덱싱 최종 구성, 라이브 오케스트레이터, 방(K) 자동화·이미지 매칭, 비용 추적. 별도 repo [mind-palace-graphrag](https://github.com/liminal-cipher/mind-palace-graphrag) (2026-08-10 기준 242/259 커밋, 93%) |
...
| repo 통합 관리 | 팀 정본 PR #1~#24를 통한 통합 작업, 데모 모드 온오프, 지역 간 데이터 누수·memory-walk 상태 버그 수정 |
